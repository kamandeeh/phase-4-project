        ...
        <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              ...
              <p className={`text-sm font-semibold ${current_user.is_approved ? "text-green-600 border p-3" : "text-red-600"}`}>
...
export default ProfilePage; // ✅ Ensure it's exported as default
